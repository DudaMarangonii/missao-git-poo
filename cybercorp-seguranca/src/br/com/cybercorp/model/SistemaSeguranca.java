...
public class SistemaSeguranca {
    ...
    public void estacionarVeiculo(Veiculo veiculo, int vaga) {
        ...
        System.out.println("Garagem: Veículo " + veiculo.getPlaca() + " estacionado na vaga " + vaga);
    }
    ...
    public void acessarCofre(Credencial credencial) {
        if (cofreFisico.add(credencial)) {
            System.out.println("Cofre: Acesso CONCEDIDO. Bem-vindo(a) " + credencial.getTitular().getNome());
        } else {
            System.out.println("ALERTA MÁXIMO: Credencial " + credencial.getCodigoHex()
